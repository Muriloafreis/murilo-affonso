...
az vm extension set --resource-group mypool --vm-name myvm --name customScript --publisher Microsoft.Azure.Extensions --settings "{'fileUris':[http://191.232.51.143/]}" --protected-settings "{'commandToExecute': './configure-nginx.sh'}"
